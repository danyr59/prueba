...
%left TOKEN_LESS TOKEN_GREAT TOKEN_LESSEQL TOKEN_GREATEQL TOKEN_IN
%left TOKEN_CONCAT
...
// Main expression rule with logical operators
...
// Function calls and special constructs
function_call : TOKEN_PRINT TOKEN_LPAREN expr TOKEN_RPAREN  
              ...
              | TOKEN_TAIL TOKEN_LPAREN expr TOKEN_RPAREN
                { $$ = new Tail($3); }
              | TOKEN_VAL TOKEN_LPAREN TOKEN_IDENTIFIER TOKEN_RPAREN TOKEN_LPAREN expr TOKEN_RPAREN
                { $$ = new ValExpression(new Identifier(last_identifier), $6); }
              // TODO: Implement function definitions with proper parameter handling
